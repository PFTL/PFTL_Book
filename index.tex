...
\newenvironment{warning}[1]{%
    \begin{tcolorbox}[width=\textwidth,colframe={pftl-red}, colback=pftl-red!5!white, title={Warning}, outer arc=2mm]
    {#1}
    \end{tcolorbox}
}

\newenvironment{note}[1]{%
    \begin{tcolorbox}[width=\textwidth,colframe={pftl-blue}, colback=pftl-blue!5!white, title={Note}, outer arc=2mm]
    {#1}
    \end{tcolorbox}
}

\newenvironment{exercise}[1]{%
    \begin{tcolorbox}[width=\textwidth,colframe={pftl-green}, colback={pftl-light}, title={Exercise},outer arc=2mm]
    {#1}
    \end{tcolorbox}
}
