...
\exercise{Update the method \texttt{get\_voltage} so it generates an in volts. Pay attention to the fact that you need to import Pint and create the unit registry before you define your class to be able to use it.}
